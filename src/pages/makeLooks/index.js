...
export default function MakeupLooks() {
  ...
  async function verify() {
    const conf = {
      code: "Z1707288285474277",
      id: "1c22cb25-7f90-4df6-b27e-1f44483cf9e3",
    };
  ...
  return (
    <div>
      ...
      <div className="bg-[#f7f0e7] sm:py-[80px] py-[60px] px-[25px]">
        ...
        <div
          onClick={checkTrue}
          className="cursor-pointer bg-[#4F2323] font-medium max-w-max w-[100%] m-auto h-[71px] rounded-full sm:text-[20px] text-[16px] flex justify-center items-center text-white mt-[20px] px-8"
        >
          Claim using my HH Community Membership Card
        </div>
